...
export async function checkCardExists(type: cardRepository.TransactionTypes, employeeId: number) {
...
export function checkActive(password: string | null, active: boolean) {
...
export function checkExpired(expirationDate: string) {
...
export function checkBlocked(isBlocked: boolean, blocked: boolean) {
